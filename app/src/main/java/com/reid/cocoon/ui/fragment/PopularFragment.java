...
public class PopularFragment extends DisposableFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadData(boolean loadMore) {
        ...
        Disposable disposable = mPhotoLoader.getCuratedPhotos(curPage, 10, "popular")
