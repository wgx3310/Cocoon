...
public class NetHelper {
     ...
     * @return 网络类型
     * <ul>
     * <li>{@link NetType#NETWORK_WIFI   } </li>
     * <li>{@link NetType#NETWORK_4G     } </li>
     * <li>{@link NetType#NETWORK_3G     } </li>
     * <li>{@link NetType#NETWORK_2G     } </li>
     * <li>{@link NetType#NETWORK_UNKNOWN} </li>
     * <li>{@link NetType#NETWORK_NO     } </li>
     * </ul>
     */
